...
import static github.tsffish.bedwarskit.config.task.TaskConfigHandler.gametask_name_iron3;
...
public class TaskIron3 {
    ...
    public static void runTask(Game game){
        ...
        gameTaskTime = TaskConfigHandler.gametask_spawntime_tasks_iron3;
            ...
            public void run() {
                ...
                if (x <= 0){
                    ...
                    for (Map.Entry<Integer, String> entry : getAllTask().entrySet()) {
                        if (entry.getValue().equals(gametask_name_iron3)) {
                            ...
                            for (ItemStack item : list.getResources()) {
                                if (item != null) {
                                    ...
                                    if (itemType == Material.IRON_INGOT) {
                                        list.setInterval(TaskConfigHandler.gametask_spawntime_iron_3);
                                    }
                                }
                            }
                        }
                    ...
                    if (game.getPlayers() != null){
                        for(Player p : game.getPlayers()) {
                            if (p != null && p.isOnline()){
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_iron3_chat, "")) {
                                    p.sendMessage(TaskConfigHandler.gametask_mess_iron3_chat);
                                }
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_iron3_title, "")) {
                                    String titleReal = t(TaskConfigHandler.gametask_mess_iron3_title);
                                    if (!Objects.equals(TaskConfigHandler.gametask_mess_iron3_subtitle, "")) {
                                        String subtitleReal = t(TaskConfigHandler.gametask_mess_iron3_subtitle);

                                        p.sendTitle(titleReal, subtitleReal);
                                    }
                                } else if (!Objects.equals(TaskConfigHandler.gametask_mess_iron3_subtitle, "")) {
                                    String titleReal = " ";
                                    String subtitleReal = t(TaskConfigHandler.gametask_mess_iron3_subtitle);

                                    p.sendTitle(titleReal, subtitleReal);
                                }
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_iron3_actionbar, "")) {
                                    sendActionBar(p, t(TaskConfigHandler.gametask_mess_iron3_actionbar));
                                }
                            }
                        }
                    }
