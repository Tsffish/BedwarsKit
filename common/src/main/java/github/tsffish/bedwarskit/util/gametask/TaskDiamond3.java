...
import static github.tsffish.bedwarskit.config.task.TaskConfigHandler.gametask_name_diamond3;
...
public class TaskDiamond3 {
    ...
    public static void runTask(Game game){
        ...
        gameTaskTime = TaskConfigHandler.gametask_spawntime_tasks_diamond3;
                            ...
                            for (ItemStack item : list.getResources()) {
                                if (item != null) {
                                    ...
                                    if (itemType == Material.DIAMOND) {
                                        list.setInterval(TaskConfigHandler.gametask_spawntime_diamond_3);
                                    }
                                }
                            }
                        }
                    ...
                    if (game.getPlayers() != null){
                        for(Player p : game.getPlayers()) {
                            if (p != null && p.isOnline()){
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_diamond3_chat, "")) {
                                    p.sendMessage(TaskConfigHandler.gametask_mess_diamond3_chat);
                                }
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_diamond3_title, "")) {
                                    String titleReal = t(TaskConfigHandler.gametask_mess_diamond3_title);
                                    if (!Objects.equals(TaskConfigHandler.gametask_mess_diamond3_subtitle, "")) {
                                        String subtitleReal = t(TaskConfigHandler.gametask_mess_diamond3_subtitle);

                                        p.sendTitle(titleReal, subtitleReal);
                                    }
                                } else if (!Objects.equals(TaskConfigHandler.gametask_mess_diamond3_subtitle, "")) {
                                    String titleReal = " ";
                                    String subtitleReal = t(TaskConfigHandler.gametask_mess_diamond3_subtitle);

                                    p.sendTitle(titleReal, subtitleReal);
                                }
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_diamond3_actionbar, "")) {
                                    sendActionBar(p, t(TaskConfigHandler.gametask_mess_diamond3_actionbar));
                                }
                            }
                        }
                    }
