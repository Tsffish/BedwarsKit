...
import static github.tsffish.bedwarskit.config.task.TaskConfigHandler.gametask_name_emerald1;
...
public class TaskEmerald1 {
    ...
    public static void runTask(Game game){
        ...
        gameTaskTime = TaskConfigHandler.gametask_spawntime_tasks_emerald1;
                ...
                for (ResourceSpawner list : resourceSpawner) {
                        ...
                        for (ItemStack item : list.getResources()) {
                            if (item != null) {
                                ...
                                if (itemType == Material.EMERALD) {
                                    list.setInterval(TaskConfigHandler.gametask_spawntime_emerald_1);
                                }
                            }
                        }
                    }
                    ...
                    if (game.getPlayers() != null){
                        for(Player p : game.getPlayers()) {
                            ...
                            if (!Objects.equals(TaskConfigHandler.gametask_mess_emerald1_chat, "")) {
                                p.sendMessage(TaskConfigHandler.gametask_mess_emerald1_chat);
                            }
                            if (!Objects.equals(TaskConfigHandler.gametask_mess_emerald1_title, "")) {
                                String titleReal = t(TaskConfigHandler.gametask_mess_emerald1_title);
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_emerald1_subtitle, "")) {
                                    String subtitleReal = t(TaskConfigHandler.gametask_mess_emerald1_subtitle);

                                    p.sendTitle(titleReal, subtitleReal);
                                }
                            } else if (!Objects.equals(TaskConfigHandler.gametask_mess_emerald1_subtitle, "")) {
                                String titleReal = " ";
                                String subtitleReal = t(TaskConfigHandler.gametask_mess_emerald1_subtitle);

                                p.sendTitle(titleReal, subtitleReal);
                            }
                            if (!Objects.equals(TaskConfigHandler.gametask_mess_emerald1_actionbar, "")) {
                                sendActionBar(p, t(TaskConfigHandler.gametask_mess_emerald1_actionbar));
                            }
                            }
                        }
                    }
