...
import static github.tsffish.bedwarskit.config.task.TaskConfigHandler.gametask_name_diamond1;
...
public class TaskDiamond1 {
    ...
    public static void runTask(Game game){
        ...
        gameTaskTime = TaskConfigHandler.gametask_spawntime_tasks_diamond1;
                ...
                for (ResourceSpawner list : resourceSpawner) {
                        ...
                        for (ItemStack item : list.getResources()) {
                            if (item != null) {
                                ...
                                if (itemType == Material.DIAMOND) {
                                    list.setInterval(TaskConfigHandler.gametask_spawntime_diamond_1);
                                }
                            }
                        }
                    }
                    ...
                    if (game.getPlayers() != null){
                        for(Player p : game.getPlayers()) {
                            ...
                            if (!Objects.equals(TaskConfigHandler.gametask_mess_diamond1_chat, "")) {
                                p.sendMessage(TaskConfigHandler.gametask_mess_diamond1_chat);
                            }
                            if (!Objects.equals(TaskConfigHandler.gametask_mess_diamond1_title, "")) {
                                String titleReal = t(TaskConfigHandler.gametask_mess_diamond1_title);
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_diamond1_subtitle, "")) {
                                    String subtitleReal = t(TaskConfigHandler.gametask_mess_diamond1_subtitle);

                                    p.sendTitle(titleReal, subtitleReal);
                                }
                            } else if (!Objects.equals(TaskConfigHandler.gametask_mess_diamond1_subtitle, "")) {
                                String titleReal = " ";
                                String subtitleReal = t(TaskConfigHandler.gametask_mess_diamond1_subtitle);

                                p.sendTitle(titleReal, subtitleReal);
                            }
                            if (!Objects.equals(TaskConfigHandler.gametask_mess_diamond1_actionbar, "")) {
                                sendActionBar(p, t(TaskConfigHandler.gametask_mess_diamond1_actionbar));
                            }
                            }
                        }
                    }
