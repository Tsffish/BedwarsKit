...
import static github.tsffish.bedwarskit.config.task.TaskConfigHandler.gametask_name_gold3;
...
public class TaskGold3 {
    ...
    public static void runTask(Game game){
        ...
        gameTaskTime = TaskConfigHandler.gametask_spawntime_tasks_gold3;
                            ...
                            for (ItemStack item : list.getResources()) {
                                if (item != null) {
                                    ...
                                    if (itemType == Material.GOLD_INGOT) {
                                        list.setInterval(TaskConfigHandler.gametask_spawntime_gold_3);
                                    }
                                }
                            }
                        }
                    ...
                    if (game.getPlayers() != null){
                        for(Player p : game.getPlayers()) {
                            if (p != null && p.isOnline()){
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_gold3_chat, "")) {
                                    p.sendMessage(TaskConfigHandler.gametask_mess_gold3_chat);
                                }
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_gold3_title, "")) {
                                    String titleReal = t(TaskConfigHandler.gametask_mess_gold3_title);
                                    if (!Objects.equals(TaskConfigHandler.gametask_mess_gold3_subtitle, "")) {
                                        String subtitleReal = t(TaskConfigHandler.gametask_mess_gold3_subtitle);

                                        p.sendTitle(titleReal, subtitleReal);
                                    }
                                } else if (!Objects.equals(TaskConfigHandler.gametask_mess_gold3_subtitle, "")) {
                                    String titleReal = " ";
                                    String subtitleReal = t(TaskConfigHandler.gametask_mess_gold3_subtitle);

                                    p.sendTitle(titleReal, subtitleReal);
                                }
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_gold3_actionbar, "")) {
                                    sendActionBar(p, t(TaskConfigHandler.gametask_mess_gold3_actionbar));
                                }
                            }
                        }
                    }
