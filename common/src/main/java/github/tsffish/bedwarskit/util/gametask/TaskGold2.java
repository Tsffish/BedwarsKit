...
import static github.tsffish.bedwarskit.config.task.TaskConfigHandler.gametask_name_gold2;
...
public class TaskGold2 {
    ...
    public static void runTask(Game game){
        ...
        gameTaskTime = TaskConfigHandler.gametask_spawntime_tasks_gold2;
                            ...
                            for (ItemStack item : list.getResources()) {
                                if (item != null) {
                                    ...
                                    if (itemType == Material.GOLD_INGOT) {
                                        list.setInterval(TaskConfigHandler.gametask_spawntime_gold_2);
                                    }
                                }
                            }
                        }
                    ...
                    if (game.getPlayers() != null){
                        for(Player p : game.getPlayers()) {
                            if (p != null && p.isOnline()){
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_gold2_chat, "")) {
                                    p.sendMessage(TaskConfigHandler.gametask_mess_gold2_chat);
                                }
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_gold2_title, "")) {
                                    String titleReal = t(TaskConfigHandler.gametask_mess_gold2_title);
                                    if (!Objects.equals(TaskConfigHandler.gametask_mess_gold2_subtitle, "")) {
                                        String subtitleReal = t(TaskConfigHandler.gametask_mess_gold2_subtitle);

                                        p.sendTitle(titleReal, subtitleReal);
                                    }
                                } else if (!Objects.equals(TaskConfigHandler.gametask_mess_gold2_subtitle, "")) {
                                    String titleReal = " ";
                                    String subtitleReal = t(TaskConfigHandler.gametask_mess_gold2_subtitle);

                                    p.sendTitle(titleReal, subtitleReal);
                                }
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_gold2_actionbar, "")) {
                                    sendActionBar(p, t(TaskConfigHandler.gametask_mess_gold2_actionbar));
                                }
                            }
                        }
                    }
