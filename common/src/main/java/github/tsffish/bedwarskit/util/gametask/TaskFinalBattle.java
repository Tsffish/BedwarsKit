                    ...
                    if (game.getPlayers() != null){
                        for(Player p : game.getPlayers()) {
                            if (p != null && p.isOnline()){
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_finalbattle_chat, "")) {
                                    p.sendMessage(t(TaskConfigHandler.gametask_mess_finalbattle_chat));
                                }
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_finalbattle_title, "")) {
                                    String titleReal = t(TaskConfigHandler.gametask_mess_finalbattle_title);
                                    if (!Objects.equals(TaskConfigHandler.gametask_mess_finalbattle_subtitle, "")) {
                                        String subtitleReal = t(TaskConfigHandler.gametask_mess_finalbattle_subtitle);

                                        p.sendTitle(titleReal, subtitleReal);
                                    }
                                } else if (!Objects.equals(TaskConfigHandler.gametask_mess_finalbattle_subtitle, "")) {
                                    String titleReal = " ";
                                    String subtitleReal = t(TaskConfigHandler.gametask_mess_finalbattle_subtitle);

                                    p.sendTitle(titleReal, subtitleReal);
                                }
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_finalbattle_actionbar, "")) {
                                    sendActionBar(p, t(TaskConfigHandler.gametask_mess_finalbattle_actionbar));
                                }
                            }
                        }
                    }
