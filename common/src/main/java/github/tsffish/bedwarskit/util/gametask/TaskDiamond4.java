...
import static github.tsffish.bedwarskit.config.task.TaskConfigHandler.gametask_name_diamond4;
...
public class TaskDiamond4 {
    ...
    public static void runTask(Game game){
        ...
        gameTaskTime = TaskConfigHandler.gametask_spawntime_tasks_diamond4;
                            ...
                            for (ItemStack item : list.getResources()) {
                                if (item != null) {
                                    ...
                                    if (itemType == Material.DIAMOND) {
                                        list.setInterval(TaskConfigHandler.gametask_spawntime_diamond_4);
                                    }
                                }
                            }
                        }
                    ...
                    if (game.getPlayers() != null){
                        for(Player p : game.getPlayers()) {
                            if (p != null && p.isOnline()){
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_diamond4_chat, "")) {
                                    p.sendMessage(TaskConfigHandler.gametask_mess_diamond4_chat);
                                }
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_diamond4_title, "")) {
                                    String titleReal = t(TaskConfigHandler.gametask_mess_diamond4_title);
                                    if (!Objects.equals(TaskConfigHandler.gametask_mess_diamond4_subtitle, "")) {
                                        String subtitleReal = t(TaskConfigHandler.gametask_mess_diamond4_subtitle);

                                        p.sendTitle(titleReal, subtitleReal);
                                    }
                                } else if (!Objects.equals(TaskConfigHandler.gametask_mess_diamond4_subtitle, "")) {
                                    String titleReal = " ";
                                    String subtitleReal = t(TaskConfigHandler.gametask_mess_diamond4_subtitle);

                                    p.sendTitle(titleReal, subtitleReal);
                                }
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_diamond4_actionbar, "")) {
                                    sendActionBar(p, t(TaskConfigHandler.gametask_mess_diamond4_actionbar));
                                }
                            }
                        }
                    }
