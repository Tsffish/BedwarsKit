 ...
 * @author Tsffish
 */
public class ResDiamondTextTask {
    ...
    public ResDiamondTextTask(Game game) {
        this.game = game;
                ...
                if (!Objects.equals(resText1_Diamond, "")) {
                    ...
                    new BukkitRunnable() {
                        ...
                        public void run() {
                            ...
                            armorStand.setCustomName(t(resText1_Diamond.replace("{s}", resTime.get(Material.DIAMOND) + "")));
                        }
                ...
                if (!Objects.equals(resText2_Diamond, "")) {
                    ...
                    new BukkitRunnable() {
                        ...
                        public void run() {
                            ...
                            armorStand.setCustomName(t(resText2_Diamond.replace("{s}", resTime.get(Material.DIAMOND) + "")));
                ...
                if (!Objects.equals(resText3_Diamond, "")) {
                    ...
                    new BukkitRunnable() {
                        ...
                        public void run() {
                            ...
                            armorStand.setCustomName(t(resText3_Diamond.replace("{s}", resTime.get(Material.DIAMOND) + "")));
                        }
                    }.runTaskTimer(plugin, 0L, 20L);
                }
    ...
    private void runCountDownTask(ResourceSpawner resourceSpawner) {
        if (!isRunning) {
            isRunning = true;
            resTime.put(Material.DIAMOND, resourceSpawner.getInterval() / 1000);
            new BukkitRunnable() {
                ...
                public void run() {
                    ...
                    resTime.put(Material.DIAMOND, resTime.get(Material.DIAMOND) - 1);

                    if (resTime.get(Material.DIAMOND) <= 0) {
                        resTime.put(Material.DIAMOND, resourceSpawner.getInterval() / 1000);
                    }
