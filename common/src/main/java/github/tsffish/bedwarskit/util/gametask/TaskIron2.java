...
import static github.tsffish.bedwarskit.config.task.TaskConfigHandler.gametask_name_iron2;
...
public class TaskIron2 {
    ...
    public static void runTask(Game game){
        ...
        gameTaskTime = TaskConfigHandler.gametask_spawntime_tasks_iron2;
                            ...
                            for (ItemStack item : list.getResources()) {
                                if (item != null) {
                                    ...
                                    if (itemType == Material.IRON_INGOT) {
                                        list.setInterval(TaskConfigHandler.gametask_spawntime_iron_2);
                                    }
                                }
                            }
                        }
                    ...
                    if (game.getPlayers() != null){
                        for(Player p : game.getPlayers()) {
                            if (p != null && p.isOnline()){
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_iron2_chat, "")) {
                                    p.sendMessage(TaskConfigHandler.gametask_mess_iron2_chat);
                                }
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_iron2_title, "")) {
                                    String titleReal = t(TaskConfigHandler.gametask_mess_iron2_title);
                                    if (!Objects.equals(TaskConfigHandler.gametask_mess_iron2_subtitle, "")) {
                                        String subtitleReal = t(TaskConfigHandler.gametask_mess_iron2_subtitle);

                                        p.sendTitle(titleReal, subtitleReal);
                                    }
                                } else if (!Objects.equals(TaskConfigHandler.gametask_mess_iron2_subtitle, "")) {
                                    String titleReal = " ";
                                    String subtitleReal = t(TaskConfigHandler.gametask_mess_iron2_subtitle);

                                    p.sendTitle(titleReal, subtitleReal);
                                }
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_iron2_actionbar, "")) {
                                    sendActionBar(p, t(TaskConfigHandler.gametask_mess_iron2_actionbar));
                                }
                            }
                        }
                    }
