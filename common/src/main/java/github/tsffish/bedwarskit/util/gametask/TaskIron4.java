...
import static github.tsffish.bedwarskit.config.task.TaskConfigHandler.gametask_name_iron4;
...
public class TaskIron4 {
    ...
    public static void runTask(Game game){
        ...
        gameTaskTime = TaskConfigHandler.gametask_spawntime_tasks_iron4;
            ...
            public void run() {
                ...
                if (x <= 0){
                    ...
                    for (Map.Entry<Integer, String> entry : getAllTask().entrySet()) {
                        if (entry.getValue().equals(gametask_name_iron4)) {
                            ...
                            for (ItemStack item : list.getResources()) {
                                if (item != null) {
                                    ...
                                    if (itemType == Material.IRON_INGOT) {
                                        list.setInterval(TaskConfigHandler.gametask_spawntime_iron_4);
                                    }
                                }
                            }
                        }
                    ...
                    if (game.getPlayers() != null){
                        for(Player p : game.getPlayers()) {
                            if (p != null && p.isOnline()){
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_iron4_chat, "")) {
                                    p.sendMessage(TaskConfigHandler.gametask_mess_iron4_chat);
                                }
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_iron4_title, "")) {
                                    String titleReal = t(TaskConfigHandler.gametask_mess_iron4_title);
                                    if (!Objects.equals(TaskConfigHandler.gametask_mess_iron4_subtitle, "")) {
                                        String subtitleReal = t(TaskConfigHandler.gametask_mess_iron4_subtitle);

                                        p.sendTitle(titleReal, subtitleReal);
                                    }
                                } else if (!Objects.equals(TaskConfigHandler.gametask_mess_iron4_subtitle, "")) {
                                    String titleReal = " ";
                                    String subtitleReal = t(TaskConfigHandler.gametask_mess_iron4_subtitle);

                                    p.sendTitle(titleReal, subtitleReal);
                                }
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_iron4_actionbar, "")) {
                                    sendActionBar(p, t(TaskConfigHandler.gametask_mess_iron4_actionbar));
                                }
                            }
                        }
                    }
