...
import static github.tsffish.bedwarskit.config.task.TaskConfigHandler.gametask_name_diamond2;
...
public class TaskDiamond2 {
    ...
    public static void runTask(Game game){
        ...
        gameTaskTime = TaskConfigHandler.gametask_spawntime_tasks_diamond2;
                            ...
                            for (ItemStack item : list.getResources()) {
                                if (item != null) {
                                    ...
                                    if (itemType == Material.DIAMOND) {
                                        list.setInterval(TaskConfigHandler.gametask_spawntime_diamond_2);
                                    }
                                }
                            }
                        }
                    ...
                    if (game.getPlayers() != null){
                        for(Player p : game.getPlayers()) {
                            if (p != null && p.isOnline()){
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_diamond2_chat, "")) {
                                    p.sendMessage(TaskConfigHandler.gametask_mess_diamond2_chat);
                                }
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_diamond2_title, "")) {
                                    String titleReal = t(TaskConfigHandler.gametask_mess_diamond2_title);
                                    if (!Objects.equals(TaskConfigHandler.gametask_mess_diamond2_subtitle, "")) {
                                        String subtitleReal = t(TaskConfigHandler.gametask_mess_diamond2_subtitle);

                                        p.sendTitle(titleReal, subtitleReal);
                                    }
                                } else if (!Objects.equals(TaskConfigHandler.gametask_mess_diamond2_subtitle, "")) {
                                    String titleReal = " ";
                                    String subtitleReal = t(TaskConfigHandler.gametask_mess_diamond2_subtitle);

                                    p.sendTitle(titleReal, subtitleReal);
                                }
                                if (!Objects.equals(TaskConfigHandler.gametask_mess_diamond2_actionbar, "")) {
                                    sendActionBar(p, t(TaskConfigHandler.gametask_mess_diamond2_actionbar));
                                }
                            }
                        }
                    }
