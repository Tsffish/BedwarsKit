...
import static github.tsffish.bedwarskit.config.lang.LangConfigHandler.vauleIsNull;
...
public class ResConfigLoad {
    private static final String className = ResConfigLoad.class.getSimpleName();
    ...
    private static void extracted(FileConfiguration c) {
        ...
        if (c.get(ResConfigPath.path_resBlock_Emerald_yawPerTick) != null) {
        ...
        if (c.get(ResConfigPath.path_resBlock_Diamond_yawPerTick) != null) {
        ...
        if (c.get(ResConfigPath.path_resBlock_Gold_yawPerTick) != null) {
        ...
        if (c.get(ResConfigPath.path_resBlock_Iron_yawPerTick) != null) {
