...
public class TaskConfigLoad {
    ...
    public static void loadTaskConfig() {
        ...
        if (c.getString(TaskConfigPath.path_gametask_time_healthset1) != null) {
            gametask_time_healthset1 = c.getInt(TaskConfigPath.path_gametask_time_healthset1);
        } else {
            sendError(TaskConfigPath.path_gametask_time_healthset1);
        }
        if (c.getString(TaskConfigPath.path_gametask_time_healthset2) != null) {
            gametask_time_healthset2 = c.getInt(TaskConfigPath.path_gametask_time_healthset2);
        } else {
            sendError(TaskConfigPath.path_gametask_time_healthset2);
        }
        if (c.getString(TaskConfigPath.path_gametask_time_healthset3) != null) {
            gametask_time_healthset3 = c.getInt(TaskConfigPath.path_gametask_time_healthset3);
        } else {
            sendError(TaskConfigPath.path_gametask_time_healthset3);
        }
        if (c.getString(TaskConfigPath.path_gametask_time_healthset4) != null) {
            gametask_time_healthset4 = c.getInt(TaskConfigPath.path_gametask_time_healthset4);
        } else {
            sendError(TaskConfigPath.path_gametask_time_healthset4);
        }


        if (c.getString(TaskConfigPath.path_gametask_name_healthset1) != null) {
            gametask_name_healthset1 = c.getString(TaskConfigPath.path_gametask_name_healthset1);
        } else {
            sendError(TaskConfigPath.path_gametask_name_healthset1);
        }
        if (c.getString(TaskConfigPath.path_gametask_name_healthset2) != null) {
            gametask_name_healthset2 = c.getString(TaskConfigPath.path_gametask_name_healthset2);
        } else {
            sendError(TaskConfigPath.path_gametask_name_healthset2);
        }


        if (c.getString(TaskConfigPath.path_gametask_name_healthset3) != null) {
            gametask_name_healthset3 = c.getString(TaskConfigPath.path_gametask_name_healthset3);
        } else {
            sendError(TaskConfigPath.path_gametask_name_healthset3);
        }
        if (c.getString(TaskConfigPath.path_gametask_name_healthset4) != null) {
            gametask_name_healthset4 = c.getString(TaskConfigPath.path_gametask_name_healthset4);
        } else {
            sendError(TaskConfigPath.path_gametask_name_healthset4);
        }




        if (c.getString(TaskConfigPath.path_gametask_mess_healthset1_chat) != null) {
            gametask_mess_healthset1_chat = c.getString(TaskConfigPath.path_gametask_mess_healthset1_chat);
        } else {
            sendError(TaskConfigPath.path_gametask_mess_healthset1_chat);
        }
        if (c.getString(TaskConfigPath.path_gametask_mess_healthset1_title) != null) {
            gametask_mess_healthset1_title = c.getString(TaskConfigPath.path_gametask_mess_healthset1_title);
        } else {
            sendError(TaskConfigPath.path_gametask_mess_healthset1_title);
        }
        if (c.getString(TaskConfigPath.path_gametask_mess_healthset1_subtitle) != null) {
            gametask_mess_healthset1_subtitle = c.getString(TaskConfigPath.path_gametask_mess_healthset1_subtitle);
        } else {
            sendError(TaskConfigPath.path_gametask_mess_healthset1_subtitle);
        }
        if (c.getString(TaskConfigPath.path_gametask_mess_healthset1_actionbar) != null) {
            gametask_mess_healthset1_actionbar = c.getString(TaskConfigPath.path_gametask_mess_healthset1_actionbar);
        } else {
            sendError(TaskConfigPath.path_gametask_mess_healthset1_actionbar);
        }

        if (c.getString(TaskConfigPath.path_gametask_mess_healthset2_chat) != null) {
            gametask_mess_healthset2_chat = c.getString(TaskConfigPath.path_gametask_mess_healthset2_chat);
        } else {
            sendError(TaskConfigPath.path_gametask_mess_healthset2_chat);
        }
        if (c.getString(TaskConfigPath.path_gametask_mess_healthset2_title) != null) {
            gametask_mess_healthset2_title = c.getString(TaskConfigPath.path_gametask_mess_healthset2_title);
        } else {
            sendError(TaskConfigPath.path_gametask_mess_healthset2_title);
        }
        if (c.getString(TaskConfigPath.path_gametask_mess_healthset2_subtitle) != null) {
            gametask_mess_healthset2_subtitle = c.getString(TaskConfigPath.path_gametask_mess_healthset2_subtitle);
        } else {
            sendError(TaskConfigPath.path_gametask_mess_healthset2_subtitle);
        }
        if (c.getString(TaskConfigPath.path_gametask_mess_healthset2_actionbar) != null) {
            gametask_mess_healthset2_actionbar = c.getString(TaskConfigPath.path_gametask_mess_healthset2_actionbar);
        } else {
            sendError(TaskConfigPath.path_gametask_mess_healthset2_actionbar);
        }

        if (c.getString(TaskConfigPath.path_gametask_mess_healthset3_chat) != null) {
            gametask_mess_healthset3_chat = c.getString(TaskConfigPath.path_gametask_mess_healthset3_chat);
        } else {
            sendError(TaskConfigPath.path_gametask_mess_healthset3_chat);
        }
        if (c.getString(TaskConfigPath.path_gametask_mess_healthset3_title) != null) {
            gametask_mess_healthset3_title = c.getString(TaskConfigPath.path_gametask_mess_healthset3_title);
        } else {
            sendError(TaskConfigPath.path_gametask_mess_healthset3_title);
        }
        if (c.getString(TaskConfigPath.path_gametask_mess_healthset3_subtitle) != null) {
            gametask_mess_healthset3_subtitle = c.getString(TaskConfigPath.path_gametask_mess_healthset3_subtitle);
        } else {
            sendError(TaskConfigPath.path_gametask_mess_healthset3_subtitle);
        }
        if (c.getString(TaskConfigPath.path_gametask_mess_healthset3_actionbar) != null) {
            gametask_mess_healthset3_actionbar = c.getString(TaskConfigPath.path_gametask_mess_healthset3_actionbar);
        } else {
            sendError(TaskConfigPath.path_gametask_mess_healthset3_actionbar);
        }
        if (c.getString(TaskConfigPath.path_gametask_mess_healthset4_chat) != null) {
            gametask_mess_healthset4_chat = c.getString(TaskConfigPath.path_gametask_mess_healthset4_chat);
        } else {
            sendError(TaskConfigPath.path_gametask_mess_healthset4_chat);
        }
        if (c.getString(TaskConfigPath.path_gametask_mess_healthset4_title) != null) {
            gametask_mess_healthset4_title = c.getString(TaskConfigPath.path_gametask_mess_healthset4_title);
        } else {
            sendError(TaskConfigPath.path_gametask_mess_healthset4_title);
        }
        if (c.getString(TaskConfigPath.path_gametask_mess_healthset4_subtitle) != null) {
            gametask_mess_healthset4_subtitle = c.getString(TaskConfigPath.path_gametask_mess_healthset4_subtitle);
        } else {
            sendError(TaskConfigPath.path_gametask_mess_healthset4_subtitle);
        }
        if (c.getString(TaskConfigPath.path_gametask_mess_healthset4_actionbar) != null) {
            gametask_mess_healthset4_actionbar = c.getString(TaskConfigPath.path_gametask_mess_healthset4_actionbar);
        } else {
            sendError(TaskConfigPath.path_gametask_mess_healthset4_actionbar);
        }


        if (c.getString(TaskConfigPath.path_gametask_healthset_1) != null) {
            gametask_healthset_1 = c.getDouble(TaskConfigPath.path_gametask_healthset_1);
        } else {
            sendError(TaskConfigPath.path_gametask_healthset_1);
        }

        if (c.getString(TaskConfigPath.path_gametask_healthset_2) != null) {
            gametask_healthset_2 = c.getDouble(TaskConfigPath.path_gametask_healthset_2);
        } else {
            sendError(TaskConfigPath.path_gametask_healthset_2);
        }

        if (c.getString(TaskConfigPath.path_gametask_healthset_3) != null) {
            gametask_healthset_3 = c.getDouble(TaskConfigPath.path_gametask_healthset_3);
        } else {
            sendError(TaskConfigPath.path_gametask_healthset_3);
        }

        if (c.getString(TaskConfigPath.path_gametask_healthset_4) != null) {
            gametask_healthset_4 = c.getDouble(TaskConfigPath.path_gametask_healthset_4);
        } else {
            sendError(TaskConfigPath.path_gametask_healthset_4);
        }
