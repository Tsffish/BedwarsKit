...
import static github.tsffish.bedwarskit.config.main.MainConfigHandler.gametask_name_emerald1;
...
public class TaskEmerald1 {
    ...
    public static void runTask(Game game){
        ...
        gameTaskTime = MainConfigHandler.gametask_spawntime_tasks_emerald1;
            ...
            public void run() {
                ...
                if (x <= 0){
                    ...
                    for (Map.Entry<Integer, String> entry : getAllTask().entrySet()) {
                        if (entry.getValue().equals(gametask_name_emerald1)) {
                ...
                for (ResourceSpawner list : resourceSpawner) {
                        ...
                        for (ItemStack item : list.getResources()) {
                            if (item != null) {
                                ...
                                if (itemType == Material.EMERALD) {
                                    list.setInterval(MainConfigHandler.gametask_spawntime_emerald_1);
                                }
                            }
                        }
                    }
                    ...
                    setTaskTimeLeft(gameName, 0);
                    if (game.getPlayers() != null){
                        for(Player p : game.getPlayers()) {
                            if (p != null && p.isOnline()){
                            if (!Objects.equals(MainConfigHandler.gametask_mess_emerald1_chat, "")) {
                                p.sendMessage(MainConfigHandler.gametask_mess_emerald1_chat);
                            }
                            if (!Objects.equals(MainConfigHandler.gametask_mess_emerald1_title, "")) {
                                String titleReal = t(MainConfigHandler.gametask_mess_emerald1_title);
                                if (!Objects.equals(MainConfigHandler.gametask_mess_emerald1_subtitle, "")) {
                                    String subtitleReal = t(MainConfigHandler.gametask_mess_emerald1_subtitle);

                                    p.sendTitle(titleReal, subtitleReal);
                                }
                            } else if (!Objects.equals(MainConfigHandler.gametask_mess_emerald1_subtitle, "")) {
                                String titleReal = " ";
                                String subtitleReal = t(MainConfigHandler.gametask_mess_emerald1_subtitle);

                                p.sendTitle(titleReal, subtitleReal);
                            }
                            if (!Objects.equals(MainConfigHandler.gametask_mess_emerald1_actionbar, "")) {
                                sendActionBar(p, t(MainConfigHandler.gametask_mess_emerald1_actionbar));
                            }
                            }
                        }
                    }
