...
import static github.tsffish.bedwarskit.config.main.MainConfigHandler.gametask_name_iron1;
...
public class TaskIron1 {
    ...
    public static void runTask(Game game){
        ...
        gameTaskTime = MainConfigHandler.gametask_spawntime_tasks_iron1;
                ...
                for (ResourceSpawner list : resourceSpawner) {
                        ...
                        for (ItemStack item : list.getResources()) {
                            if (item != null) {
                                ...
                                if (itemType == Material.IRON_INGOT) {
                                    list.setInterval(MainConfigHandler.gametask_spawntime_iron_1);
                                }
                            }
                        }
                    }
                    ...
                    if (game.getPlayers() != null){
                        for(Player p : game.getPlayers()) {
                            ...
                            if (!Objects.equals(MainConfigHandler.gametask_mess_iron1_chat, "")) {
                                p.sendMessage(MainConfigHandler.gametask_mess_iron1_chat);
                            }
                            if (!Objects.equals(MainConfigHandler.gametask_mess_iron1_title, "")) {
                                String titleReal = t(MainConfigHandler.gametask_mess_iron1_title);
                                if (!Objects.equals(MainConfigHandler.gametask_mess_iron1_subtitle, "")) {
                                    String subtitleReal = t(MainConfigHandler.gametask_mess_iron1_subtitle);

                                    p.sendTitle(titleReal, subtitleReal);
                                }
                            } else if (!Objects.equals(MainConfigHandler.gametask_mess_iron1_subtitle, "")) {
                                String titleReal = " ";
                                String subtitleReal = t(MainConfigHandler.gametask_mess_iron1_subtitle);

                                p.sendTitle(titleReal, subtitleReal);
                            }
                            if (!Objects.equals(MainConfigHandler.gametask_mess_iron1_actionbar, "")) {
                                sendActionBar(p, t(MainConfigHandler.gametask_mess_iron1_actionbar));
                            }
                            }
                        }
                    }
