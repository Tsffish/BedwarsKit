...
import static github.tsffish.bedwarskit.config.main.MainConfigHandler.gametask_name_finalbattle;
...
public class TaskGold4 {
    ...
    public static void runTask(Game game){
        ...
        gameTaskTime = MainConfigHandler.gametask_spawntime_tasks_gold4;
                            ...
                            for (ItemStack item : list.getResources()) {
                                if (item != null) {
                                    ...
                                    if (itemType == Material.GOLD_INGOT) {
                                        list.setInterval(MainConfigHandler.gametask_spawntime_gold_4);
                                    }
                                }
                            }
                        }
                    ...
                    if (game.getPlayers() != null){
                        for(Player p : game.getPlayers()) {
                            if (p != null && p.isOnline()){
                                if (!Objects.equals(MainConfigHandler.gametask_mess_gold4_chat, "")) {
                                    p.sendMessage(MainConfigHandler.gametask_mess_gold4_chat);
                                }
                                if (!Objects.equals(MainConfigHandler.gametask_mess_gold4_title, "")) {
                                    String titleReal = t(MainConfigHandler.gametask_mess_gold4_title);
                                    if (!Objects.equals(MainConfigHandler.gametask_mess_gold4_subtitle, "")) {
                                        String subtitleReal = t(MainConfigHandler.gametask_mess_gold4_subtitle);

                                        p.sendTitle(titleReal, subtitleReal);
                                    }
                                } else if (!Objects.equals(MainConfigHandler.gametask_mess_gold4_subtitle, "")) {
                                    String titleReal = " ";
                                    String subtitleReal = t(MainConfigHandler.gametask_mess_gold4_subtitle);

                                    p.sendTitle(titleReal, subtitleReal);
                                }
                                if (!Objects.equals(MainConfigHandler.gametask_mess_gold4_actionbar, "")) {
                                    sendActionBar(p, t(MainConfigHandler.gametask_mess_gold4_actionbar));
                                }
                            }
                        }
                    }
