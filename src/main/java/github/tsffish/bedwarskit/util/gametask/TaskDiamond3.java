...
import static github.tsffish.bedwarskit.config.main.MainConfigHandler.gametask_name_diamond3;
...
public class TaskDiamond3 {
    ...
    private static Map<String, Integer> taskTimeLeftMap = new HashMap<>(4);
    ...
    public static void runTask(Game game){
        ...
        gameTaskTime = MainConfigHandler.gametask_spawntime_tasks_diamond3;
            ...
            public void run() {
                ...
                if (x <= 0){
                    ...
                    for (Map.Entry<Integer, String> entry : getAllTask().entrySet()) {
                        if (entry.getValue().equals(gametask_name_diamond3)) {
                            ...
                            for (ItemStack item : list.getResources()) {
                                if (item != null) {
                                    ...
                                    if (itemType == Material.DIAMOND) {
                                        list.setInterval(MainConfigHandler.gametask_spawntime_diamond_3);
                                    }
                                }
                            }
                        }
                    ...
                    if (game.getPlayers() != null){
                        for(Player p : game.getPlayers()) {
                            if (p != null && p.isOnline()){
                                if (!Objects.equals(MainConfigHandler.gametask_mess_diamond3_chat, "")) {
                                    p.sendMessage(MainConfigHandler.gametask_mess_diamond3_chat);
                                }
                                if (!Objects.equals(MainConfigHandler.gametask_mess_diamond3_title, "")) {
                                    String titleReal = t(MainConfigHandler.gametask_mess_diamond3_title);
                                    if (!Objects.equals(MainConfigHandler.gametask_mess_diamond3_subtitle, "")) {
                                        String subtitleReal = t(MainConfigHandler.gametask_mess_diamond3_subtitle);

                                        p.sendTitle(titleReal, subtitleReal);
                                    }
                                } else if (!Objects.equals(MainConfigHandler.gametask_mess_diamond3_subtitle, "")) {
                                    String titleReal = " ";
                                    String subtitleReal = t(MainConfigHandler.gametask_mess_diamond3_subtitle);

                                    p.sendTitle(titleReal, subtitleReal);
                                }
                                if (!Objects.equals(MainConfigHandler.gametask_mess_diamond3_actionbar, "")) {
                                    sendActionBar(p, t(MainConfigHandler.gametask_mess_diamond3_actionbar));
                                }
                            }
                        }
                    }
