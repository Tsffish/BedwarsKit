...
import static github.tsffish.bedwarskit.config.main.MainConfigHandler.gametask_name_gold1;
...
public class TaskGold1 {
    ...
    public static void runTask(Game game){
        ...
        gameTaskTime = MainConfigHandler.gametask_spawntime_tasks_gold1;
                ...
                for (ResourceSpawner list : resourceSpawner) {
                        ...
                        for (ItemStack item : list.getResources()) {
                            if (item != null) {
                                ...
                                if (itemType == Material.GOLD_INGOT) {
                                    list.setInterval(MainConfigHandler.gametask_spawntime_gold_1);
                                }
                            }
                        }
                    }
                    ...
                    if (game.getPlayers() != null){
                        for(Player p : game.getPlayers()) {
                            ...
                            if (!Objects.equals(MainConfigHandler.gametask_mess_gold1_chat, "")) {
                                p.sendMessage(MainConfigHandler.gametask_mess_gold1_chat);
                            }
                            if (!Objects.equals(MainConfigHandler.gametask_mess_gold1_title, "")) {
                                String titleReal = t(MainConfigHandler.gametask_mess_gold1_title);
                                if (!Objects.equals(MainConfigHandler.gametask_mess_gold1_subtitle, "")) {
                                    String subtitleReal = t(MainConfigHandler.gametask_mess_gold1_subtitle);

                                    p.sendTitle(titleReal, subtitleReal);
                                }
                            } else if (!Objects.equals(MainConfigHandler.gametask_mess_gold1_subtitle, "")) {
                                String titleReal = " ";
                                String subtitleReal = t(MainConfigHandler.gametask_mess_gold1_subtitle);

                                p.sendTitle(titleReal, subtitleReal);
                            }
                            if (!Objects.equals(MainConfigHandler.gametask_mess_gold1_actionbar, "")) {
                                sendActionBar(p, t(MainConfigHandler.gametask_mess_gold1_actionbar));
                            }
                            }
                        }
                    }
