...
import static github.tsffish.bedwarskit.config.main.MainConfigHandler.gametask_name_iron3;
...
public class TaskIron3 {
    ...
    public static void runTask(Game game){
        ...
        gameTaskTime = MainConfigHandler.gametask_spawntime_tasks_iron3;
                            ...
                            for (ItemStack item : list.getResources()) {
                                if (item != null) {
                                    ...
                                    if (itemType == Material.IRON_INGOT) {
                                        list.setInterval(MainConfigHandler.gametask_spawntime_iron_3);
                                    }
                                }
                            }
                        }
                    ...
                    if (game.getPlayers() != null){
                        for(Player p : game.getPlayers()) {
                            if (p != null && p.isOnline()){
                                if (!Objects.equals(MainConfigHandler.gametask_mess_iron3_chat, "")) {
                                    p.sendMessage(MainConfigHandler.gametask_mess_iron3_chat);
                                }
                                if (!Objects.equals(MainConfigHandler.gametask_mess_iron3_title, "")) {
                                    String titleReal = t(MainConfigHandler.gametask_mess_iron3_title);
                                    if (!Objects.equals(MainConfigHandler.gametask_mess_iron3_subtitle, "")) {
                                        String subtitleReal = t(MainConfigHandler.gametask_mess_iron3_subtitle);

                                        p.sendTitle(titleReal, subtitleReal);
                                    }
                                } else if (!Objects.equals(MainConfigHandler.gametask_mess_iron3_subtitle, "")) {
                                    String titleReal = " ";
                                    String subtitleReal = t(MainConfigHandler.gametask_mess_iron3_subtitle);

                                    p.sendTitle(titleReal, subtitleReal);
                                }
                                if (!Objects.equals(MainConfigHandler.gametask_mess_iron3_actionbar, "")) {
                                    sendActionBar(p, t(MainConfigHandler.gametask_mess_iron3_actionbar));
                                }
                            }
                        }
                    }
