...
import static github.tsffish.bedwarskit.config.main.MainConfigHandler.gametask_name_emerald2;
...
public class TaskEmerald2 {
    ...
    public static void runTask(Game game){
        ...
        gameTaskTime = MainConfigHandler.gametask_spawntime_tasks_emerald2;
                            ...
                            for (ItemStack item : list.getResources()) {
                                if (item != null) {
                                    ...
                                    if (itemType == Material.EMERALD) {
                                        list.setInterval(MainConfigHandler.gametask_spawntime_emerald_2);
                                    }
                                }
                            }
                        }
                    ...
                    if (game.getPlayers() != null){
                        for(Player p : game.getPlayers()) {
                            if (p != null && p.isOnline()){
                                if (!Objects.equals(MainConfigHandler.gametask_mess_emerald2_chat, "")) {
                                    p.sendMessage(MainConfigHandler.gametask_mess_emerald2_chat);
                                }
                                if (!Objects.equals(MainConfigHandler.gametask_mess_emerald2_title, "")) {
                                    String titleReal = t(MainConfigHandler.gametask_mess_emerald2_title);
                                    if (!Objects.equals(MainConfigHandler.gametask_mess_emerald2_subtitle, "")) {
                                        String subtitleReal = t(MainConfigHandler.gametask_mess_emerald2_subtitle);

                                        p.sendTitle(titleReal, subtitleReal);
                                    }
                                } else if (!Objects.equals(MainConfigHandler.gametask_mess_emerald2_subtitle, "")) {
                                    String titleReal = " ";
                                    String subtitleReal = t(MainConfigHandler.gametask_mess_emerald2_subtitle);

                                    p.sendTitle(titleReal, subtitleReal);
                                }
                                if (!Objects.equals(MainConfigHandler.gametask_mess_emerald2_actionbar, "")) {
                                    sendActionBar(p, t(MainConfigHandler.gametask_mess_emerald2_actionbar));
                                }
                            }
                        }
                    }
