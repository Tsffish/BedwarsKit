                            ...
                            for (ItemStack item : list.getResources()) {
                                if (item != null) {
                                    ...
                                    if (itemType == Material.EMERALD) {
                                        list.setInterval(MainConfigHandler.gametask_spawntime_emerald_3);
                                    }
                                }
                            }
                        }
                    ...
                    if (game.getPlayers() != null){
                        for(Player p : game.getPlayers()) {
                            if (p != null && p.isOnline()){
                                if (!Objects.equals(MainConfigHandler.gametask_mess_emerald3_chat, "")) {
                                    p.sendMessage(MainConfigHandler.gametask_mess_emerald3_chat);
                                }
                                if (!Objects.equals(MainConfigHandler.gametask_mess_emerald3_title, "")) {
                                    String titleReal = t(MainConfigHandler.gametask_mess_emerald3_title);
                                    if (!Objects.equals(MainConfigHandler.gametask_mess_emerald3_subtitle, "")) {
                                        String subtitleReal = t(MainConfigHandler.gametask_mess_emerald3_subtitle);

                                        p.sendTitle(titleReal, subtitleReal);
                                    }
                                } else if (!Objects.equals(MainConfigHandler.gametask_mess_emerald3_subtitle, "")) {
                                    String titleReal = " ";
                                    String subtitleReal = t(MainConfigHandler.gametask_mess_emerald3_subtitle);

                                    p.sendTitle(titleReal, subtitleReal);
                                }
                                if (!Objects.equals(MainConfigHandler.gametask_mess_emerald3_actionbar, "")) {
                                    sendActionBar(p, t(MainConfigHandler.gametask_mess_emerald3_actionbar));
                                }
                            }
                        }
                    }
